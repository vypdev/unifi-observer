...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            api_mode=os.getenv("UNIFI_API_MODE", "site-manager").strip().lower(),
    ...
    def validate(self) -> None:
        if self.api_mode not in {"site-manager", "network-integration"}:
            raise ValueError("UNIFI_API_MODE must be site-manager or network-integration")
